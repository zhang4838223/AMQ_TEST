...
/** UtilFuns is a JavaBean.  */
 public class UtilFuns {
  ...
  //截取字符,如果超过长度,截取并加省略号 by zxj 20141108
...
*/
  ...
  //类似google那样实现多个关键字的查询，关键字之间用空格或逗号隔开 by zxj 20140523
  //支持的分隔符 英文逗号,中文逗号,空格
  ...
  /* 阶梯函数,例如，a,b,c 返回 a;a,b;a,b,c by zxj 20140330 */
 ...
 */
  ...
  */
  ...
  /**
   * 判断对象o是否存在于set对象集合中 create by zxj 20140611
   */  
